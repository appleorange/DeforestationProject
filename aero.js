...
//Map.addLayer(dataset.mean(), visualization, 'RGB_Copernicus');
...
//Map.setCenter(-64.611, -3.174, 12);

Map.addLayer(dataset.mean(), visualization, 'RGB_COPERNICUS_longer_period');